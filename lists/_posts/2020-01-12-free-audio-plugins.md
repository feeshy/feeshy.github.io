...
#### [Driftmaker](https://puremagnetik.com/collections/free-plugins/products/driftmaker-delay-disintegration-device-1) / [Expanse](https://puremagnetik.com/collections/free-plugins/products/expanse-texture-generator)

![](https://cdn.shopifycdn.net/s/files/1/1561/5265/products/Driftmaker_Screenshot_1200x.png?v=1676303185)

这两款效果很难用简单的语言描述清楚，具体质感可参考下面的音乐：

- Driftmaker: [Works for Tape and Piano \| BlankFor.ms](https://blankforms.bandcamp.com/album/works-for-tape-and-piano)
- Expanse: [Into a Bright Land \| Larum \| Micah Frank](https://micahfrank.bandcamp.com/album/into-a-bright-land)
