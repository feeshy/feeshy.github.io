...
Analog Obsession专注于开发受经典硬件EQ、压缩、染色失真、通道条启发的音频插件，并为其添加超采样、MS处理、外置侧链等现代实用功能。目前已发布数十款插件，全部免费下载（如果觉得好用，[请在patreon.com支持他](https://www.patreon.com/analogobsession)）

#### [UAD Essentials](https://www.uaudio.com/products/uad-essentials-edition)

![](https://cdn.shopify.com/s/files/1/0558/1724/0665/files/UAD_essentials_edition_gallery_1.png?v=1742248644&width=1920)
UAD混音套装，12款插件涵盖压缩、EQ、通道条、染色/饱和、延迟、混响、合成器等效果。套装原价$149，但逢年过节常推出免费赠送活动，如果每次都能赶上，久而久之就能不花一分钱把套装内的插件领齐。
...
#### [BPB Saturator Plus](https://bpb.gumroad.com/l/wfjtb) / [BritChannel](https://www.patreon.com/posts/britbundle-79798060) / [PreBOX & Distox](https://analogobsession.com/color-preamp-saturation/) / [PHOENIX LT](https://www.shatteredglassaudio.com/product/115)
...
- Chamber: 免费的室内混响，[高级版解锁额外9种算法，售价$99](https://www.pspaudioware.com/products/psp-easyverb)
...
#### [Ambient Reverb](https://stone-voices.ru/vst/ambient_reverb)

![](https://stone-voices.ru/img/ambient_reverb7_s.jpg)

氛围感混响，Decay 时间可在 0.1～100 秒间大范围调节，且在整个范围内都不易产生谐振；还可通过冻结功能将尾音无限延长。最初4.3版本免费提供，后来6.0版本转为收费，2025年所有版本再次转为免费。7.0版本似乎稳定性一般，如果遇到宿主不识别或崩溃的bug，建议[尝试旧版](https://stone-voices.ru/download.php?file=ambient_reverb_all.zip)。
...
![](https://media.plugins4free.com/img/CloudSeed_2.jpg)
