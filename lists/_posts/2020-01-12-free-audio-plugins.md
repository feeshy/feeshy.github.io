...
<details>
<summary><b>ℹ️ 什么是音频插件？</b></summary>
<p>
音频插件（Audio plug-in）无法独立运行，必须加载于“音频宿主”这一软件环境中。宿主可以是具备多轨录音与混音功能的数字音频工作站（DAW），而插件则是在其中实现特定功能的扩展程序，通常表现为三种形态：为音频添加效果的效果器、作为虚拟乐器生成声音的音源，以及路由、观测信号的工具。
</p>
</details>

音频插件虽然种类繁多且更迭频繁，但市面上有很多高质量的免费音频插件，完全能够满足日常的音乐制作需求。

本文整理并汇总了百余款 VST、AU 及 AAX 格式的免费音频插件，涵盖各种常用效果类型，如均衡、压缩、延迟、混响、失真等。笔者结合自身短期试用或长期使用的感受，对每款插件进行了干货突出的介绍和点评，着重突出其特色功能和适用场景。列表中收录的内容将持续跟进，以确保时效性。
...
kilohearts 生态系统的免费插件包，提供30多款简洁、美观的效果插件——包括多达5种滤波器，非常适合音色设计。除了各大常见DAW使用的插件格式，还提供适合Reason的[Rack Extension](https://www.reasonstudios.com/shop/bundle/kilohearts-toolbox/)。
...
Analog Obsession专注于开发受经典硬件EQ、压缩[^compressor]、染色失真、通道条启发的音频插件，并为其添加超采样、MS处理、外置侧链等现代实用功能。目前已发布数十款插件，全部免费下载（如果觉得好用，[请在patreon.com支持他](https://www.patreon.com/analogobsession)）

[^compressor]:两篇比较好的关于硬件压缩器类型的科普，分别来自：[@huang jiayi](https://zhuanlan.zhihu.com/p/104533883)以及[@midifan](https://www.midifan.com/modulenews-detailview-31558.htm)

#### [UAD Explore Free](https://www.uaudio.com/products/uad-explore-free)

![](https://cdn.shopify.com/s/files/1/0558/1724/0665/files/getting-started-uad-explore-blog-feature-included-plugins.png)
UAD免费套装，包括LUNA DAW、七款音频效果（压缩、通道条、染色/饱和、混响、音箱模拟）以及一款模拟合成器。

#### Airwindows 系列

![](https://github.com/baconpaul/airwin2rack/raw/main/doc/awgalactic.png)
...
[^dynamiceq]: 关于[多段压缩与动态均衡的区别](https://www.izotope.com/en/learn/multiband-compressors-vs-dynamic-eqs.html)。
...
支持以立体声、Mid/Side，以及类似[Eventide SplitEQ](https://www.eventideaudio.com/plug-ins/spliteq/)的Transient/Sustain模式来处理
...
#### [OTT](https://xferrecords.com/freeware) / [Evil Otto](https://www.audiodamage.com/pages/evil-otto)

![](https://i.redd.it/hdf04fsrjhx81.jpg)
![](https://cdn.shopify.com/s/files/1/1550/9885/files/Screenshot_2026-03-19_at_8.55.01_PM.png)

深受电子音乐人喜爱的多频段双向压缩（压缩高电平、提升低电平），界面直观易用。

- OTT: Windows / macOS
- Evil Otto: Windows / macOS / iOS / Linux
...
顺滑的光学风格压缩，相比原版LA-2A多了Attack、Release调节，还内置了可调的过载功能

#### [Teletronix LA-2A Tube Compressor](https://www.uaudio.com/products/teletronix-la-2a-tube-compressor) & [UA 1176 FET Compressor](https://www.uaudio.com/products/ua-1176-fet)

![](https://cdn.shopify.com/s/files/1/0558/1724/0665/files/uad-explore-free-product-la-2a.jpg)
![](https://cdn.shopify.com/s/files/1/0558/1724/0665/files/uad-explore-free-product-1176.jpg)

LA-2A与1176，两款经典硬件压缩器的模拟插件。
...
两款支持外置Sidechain输入的门限器。放在鼓组send音轨混响之后，即可组合经典的80年代gated reverb效果。
...
支持外置侧链输入的Transient Shaper，在部分场景很实用。例如在叠加 Bass 音色时，我可以先用支持 Transient/ Sustain 分离处理的 EQ 处理一轨 Bass，仅保留其全频段的瞬态音头以及延音部分的高频。随后，将该信号作为侧链输入到另一轨 Bass 的 Transient Shaper 中，从而精准地切除后者的音头。支持Windows / macOS

### Resonance Suppression / Unmasking

#### [Anina](https://crql.works/anina/)

![](https://crql.works/media/ANINAIMG/AninaLabelledNew.png)

免费的谐振抑制器。支持外置侧链信号输入与Delta模式，既可以削弱音轨间互相掩蔽的频率，也可以在一个音轨加强另一个音轨的共振峰（类似Vocoder的效果）

## Color

### Pre-Amp / Saturation / Distortion

#### [Saturation Knob](https://www.softube.com/saturationknob/) / [Heatwave](https://slatedigital.com/heatwave-saturation-plugin/)

![](https://cdn.softube.com/storage/F45F15D60B921ED45EBE291145F98E0769FF079956ADBF44C26142545CFB32F9/35e961e2352947e9b10a2bbd7fb1a2e0/jpg/media/9b15c71bf05b44c08868c04297106dce/saturation-knob-product-image.jpg)
...
#### [BPB Saturator Plus](https://bpb.gumroad.com/l/wfjtb) / [Century Tube](https://www.uaudio.com/products/century-tube-channel-strip) / [UA 610](https://www.uaudio.com/products/610-collection) / [BritChannel](https://www.patreon.com/posts/britbundle-79798060) / [PreBOX & Distox](https://analogobsession.com/color-preamp-saturation/) / [PHOENIX LT](https://www.shatteredglassaudio.com/product/115)

![](https://bedroomproducersblog.com/wp-content/uploads/2025/11/saturator-plus.jpg)
![](https://cdn.shopify.com/s/files/1/0558/1724/0665/files/century_tube_channel_strip_feature_sm_1.jpg)
![](https://cdn.shopify.com/s/files/1/0558/1724/0665/files/uad-explore-free-product-610.jpg)
![](https://media.plugins4free.com/img/AO-BritChannel_2.jpg)
...
几款内置了低通/高通滤波器或EQ的饱和&失真效果，塑形，广泛适用于各种音频素材

- Saturator Plus: 电子管、磁带、二极管3合1
- Century Tube Channel Strip: 前级、EQ、光学压缩三合一通道条
- UA 610: 模拟了经典60年代模块调音台的音染
- BritPre: 70年代英式话放模拟
- PreBOX: 11合1前级模拟
...
![](https://github.com/Kiriki-liszt/JS_Inflator_to_VST2_VST3/raw/main/screenshots/screenshot_both.png)

这个插件的参数效果不太直观，且本身没有提供使用说明。不过它是 Sonnox Oxford Inflator 的复刻版，参考[原版说明书](https://dload.sonnoxplugins.com/pub/plugins/manuals/SonnoxInfMan.pdf)即可了解各项参数的含义和用法。插件最高支持 8 倍过采样（8 倍会稍微有点吃性能），支持 Windows / macOS。
...
#### [BPB Bassaturator](https://bpb.gumroad.com/l/bassaturator/BASSATURATORFREE)
...
内置3条delay line，可以通过不同的串并联方式，做出复杂的律动、延迟+合唱、混响等效果。
...
![](https://img.itch.zone/aW1nLzIzMTg1NTAxLnBuZw==/original/L%2FQ%2FLt.png)
...
#### [Verberate Basic](https://acondigital.com/products/verberate-basic)

 ![](https://static.kvraudio.com/i/b/verberate-basic-2-en.png)

一款操作简单易上手的混响，提供四种算法和一个旋钮。

#### [Ambient Reverb](https://stone-voices.ru/vst/ambient_reverb) / [DReverb](https://stone-voices.ru/vst/dreverb) / [DReverb Lite](https://stone-voices.ru/vst/dreverb_lite)

![](https://stone-voices.ru/img/ambient_reverb7_s.jpg)
![](https://stone-voices.ru/img/dreverb_2.2_s.jpg)
![](https://stone-voices.ru/img/d_reverb_lite.png)

由俄罗斯个人开发者 Vasily Makarov 开发的两款混响效果，均可免费下载；如果你觉得好用，欢迎前往作者的网站捐赠支持他。

这两款混响的共同特点是 Decay 时间可在 0.1～100 秒之间大范围调节，且在整个范围内都不易产生谐振，还可通过冻结功能将尾音无限延长。二者的区别在于算法：Ambient Reverb 使用一个侧重氛围感的混响算法，DReverb 则可在不同的参数下提供Plate/Room/Hall的空间感。

> Ambient Reverb最初的4.3版本曾经免费提供，后来6.0版本转为收费，[2025年所有版本再次转为免费](https://www.kvraudio.com/forum/viewtopic.php?t=544403&start=73)。最新的7.0版本似乎稳定性一般，如果遇到宿主不识别或崩溃的bug，建议[尝试旧版](https://stone-voices.ru/download.php?file=ambient_reverb_all.zip)。

#### [RAUM](https://www.native-instruments.com/en/products/komplete/effects/raum/)

![](https://www.native-instruments.com/typo3temp/pics/img-ce-raum-product-page-02-intro-6922f2403f318a9efe328656d5857bd8-d.jpg)

提供Room、Hall、Cosmic三种风格的算法，较长的混响时间下也有不错的声音品质。旋钮数量恰到好处，可调性较高的同时，参数也没有多到离谱，兼顾了易用性。

#### [PSP Chamber](https://www.pspaudioware.com/products/psp-chamber) / [PSP PianoVerb](https://www.pspaudioware.com/products/psp-pianoverb)

![](https://www.pspaudioware.com/assets/products/psp_chamber_freebie.jpg)
![](https://www.pspaudioware.com/assets/products/pianoverb-freebie.png)

- Chamber: 免费的室内感混响，[高级版解锁额外9种算法，售价$99](https://www.pspaudioware.com/products/psp-easyverb)
- PianoVerb: 算法使用了A(55Hz)～G#(103.8Hz)的12根钢琴琴弦作为混响材质，相比普通的混响多了些音调的感觉。基础版免费，[高级版解锁更多可调性，售价$69](https://www.pspaudioware.com/products/psp-pianoverb2)

#### [Dragonfly Reverb](https://github.com/michaelwillis/dragonfly-reverb)

![](https://github.com/michaelwillis/dragonfly-reverb/raw/master/collage.png)

开源的湿冷风格混响，UI直观，可调性丰富。提供 Room / Hall / Plate / Early Reflection 四种算法。有着空间感强烈的反射声和相对潮湿混浊的Tail，比较适合鼓、打击乐以及音效设计。少有的支持 Windows / macOS / Linux 三大平台的插件。

#### [OldSkoolVerb](https://www.voxengo.com/product/oldskoolverb/) / [MDV II](https://www.temeculadsp.com/mdv-ii)

![](https://static.kvraudio.com/i/b/voxengo_oldskoolverb_screenshot_gray.1686410836.jpg)
![](https://www.temeculadsp.com/img/mdv-ii.jpg)

两款八九十年代廉价数字混响风格的复古混响。MDV II 甚至模仿了原版 Midiverb 的 gate / reverse 包络效果。

#### [Wasted Space](https://www.softube.com/plug-ins/wasted-space) / [BPB Dirty Spring](https://bpb.gumroad.com/l/dirtyspring)

![](https://cdn.softube.com/storage/CFBE77A8FB72322FF0FD7805053B646CC50EE464BA4F7845EBFB209891D1F175/1188820f5aef4d60a41c32795f8ca73b/1020-1212-0-png.Png/media/71c4a212de1f42db9166df1940176314/wasted-space-product-image.png)
![](https://bedroomproducersblog.com/wp-content/uploads/2022/02/dirty-spring.png)

两款结合了数字失真效果的混响

- Wasted Space：板式混响+混叠失真
- BPB Dirty Spring: 弹簧混响+Bitcrusher
...
#### [CloudSeed](https://ghostnoteaudio.uk/products/cloudseed)

![](https://github.com/ValdemarOrn/CloudSeed/raw/master/interface.png)

可以囊括天空和星系的超现实混响，适合设定很长很长的Decay。[可调参数繁多，上手有难度](https://ghostnoteaudio.uk/pages/cloud-seed-user-guide)，好在开发者提供了几个预设，方便快速开始。CloudSeed的[内核开源](https://github.com/GhostNoteAudio/CloudSeedCore)，有众多版本：
...
- [Cloud Seed 2](https://ghostnoteaudio.uk/products/cloudseed): 原作者的重制版，支持VST & AU for Windows/macOS，售价£35，允许无限期全功能试用（类似Reaper）
...
#### [SOL](https://www.s1gnsofl1fe.com/sol-plugin)

![](https://static1.squarespace.com/static/64b43927b9957a51458f6afa/t/69325e503d64de1422388a66/1764908624040/final+screen+02.jpg)

一款结合了粒子引擎的混响效果。glitt、calm、shine参数控制粒子引擎，clouds、space参数控制混响。可提供与通常混响效果不同的超现实质感。
...
极简控制，效果却不简单的超现实类混响。算法源于广受好评并且更新了五代的单块以及Eurorack效果器，插件版继承了硬件版的精简旋钮，并新增了XY-Pad以混合四种算法。免费版无法保存自定义预设，可无限制使用其中的5种算法：Skynet 1, Skynet 2, Shimdown, Clean Crush, White Noise——其中Skynet算法听起来很有[Eventide Blackhole](https://store.eventideaudio.com/products/blackhole)的味道。花费$15购买高级版可解锁额外的6种混响算法以及预设保存系统。
...
#### [Atmospheres](https://zaksound.com/atmospheres/)

![](https://zaksound.com/wp-content/uploads/2024/03/atmospheres-plugin.webp)

一款免费的单旋钮混响，左下角的随机化按钮可以随机改变隐藏参数。采用了 [Deep Waters](https://zaksound.com/deep-waters/) 混响的卷积引擎。不像其他卷积混响那样侧重还原真实空间，而是侧重于构建超现实的氛围感。
...
#### [PechenegTremolo](https://pechenegfx.blogspot.com/2014/11/the-plugin-pecheneg-tremolo.html) / [HY-TP2](https://bpb.gumroad.com/l/hy-tp2/HYTP2FREE)
...
#### [HY-ESG](https://bpb.gumroad.com/l/hy-esg/HYESGFREE)
...
#### [Chow Tape Model](https://github.com/jatinchowdhury18/AnalogTapeModel) / [Tape Cassette 2](http://caelumaudio.com/CaelumAudio/?Page=TapeCassette2) / [Dirty VHS](https://bpb.gumroad.com/l/dirty-vhs/FREEVHS)

![](https://raw.githubusercontent.com/jatinchowdhury18/AnalogTapeModel/master/Plugin/Screenshots/full_gui.png)
![](https://i.imgur.com/KjwNeDR.png)
![](https://bedroomproducersblog.com/wp-content/uploads/2023/11/screenshot-1536x745.png)

基于磁带的lofi效果

- Chow Tape Model：模拟了一台Sony TC-260磁带录音机。全平台全格式支持，包括iOS。
- Tape Cassette 2：支持Windows/macOS/iOS的VST3和AUv3，不支持VST2
- Dirty VHS: 模拟VHS视频卡带的低保真效果
...
#### [Driftmaker](https://puremagnetik.com/collections/free-plugins/products/driftmaker-delay-disintegration-device-1)

![](https://cdn.shopifycdn.net/s/files/1/1561/5265/products/Driftmaker_Screenshot_1200x.png)

一款受磁带录音机启发的lofi效果，其质感可参考下面的音乐：

<iframe style="border: 0; width: 100%; height: 120px;" src="https://bandcamp.com/EmbeddedPlayer/album=1655643654/size=large/bgcol=333333/linkcol=4ec5ec/tracklist=false/artwork=small/transparent=true/" seamless><a href="https://blankforms.bandcamp.com/album/works-for-tape-and-piano">Works for Tape and Piano by BlankFor.ms</a></iframe>
...
#### [Repitch Elements](https://www.synchroarts.com/repitch)

![](https://cdn.prod.website-files.com/663a338b1522d262580b4053/6909001162f1534b6ff97d86_RePitch-Elements-UI.avif)

修音插件。简化版售价$69，注册[KVR Create](https://kvrcreate.com/)可免费获取（试用订阅后记得取消自动续费）

#### [Spoton](https://sixthsample.com/spoton/) / [MAutoPitch](https://www.meldaproduction.com/MAutoPitch)

![](https://sixthsample.com/wp-content/uploads/2024/10/Spoton-1.1.0-Live-1.png)
![](https://www.meldaproduction.com/webtemp/imagecache/screenshots/MAutoPitch00.v1.jpg)
