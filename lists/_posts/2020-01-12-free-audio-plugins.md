...
> 音频宿主是一种能够加载和运行各种音频插件的软件环境，它可以是具备多轨录音、音频编辑和混音等功能的数字音频工作站（DAW），也可以只专注于特定功能（如合成器）。音频插件是运行在宿主软件中，实现为音频添加效果、作为虚拟乐器或者监测工具等功能的扩展程序。

本文介绍了百余款可免费获取的音频效果插件，涵盖各种常用效果类型，如均衡、压缩、延迟、混响、失真等。笔者结合自身短期试用或长期使用的感受，对每款插件进行了简单的介绍和点评，着重突出了其特色功能和适用场景。
...
<iframe style="border: 0; width: 100%; height: 120px;" src="https://bandcamp.com/EmbeddedPlayer/album=1655643654/size=large/bgcol=ffffff/linkcol=0687f5/tracklist=false/artwork=small/transparent=true/" seamless><a href="https://blankforms.bandcamp.com/album/works-for-tape-and-piano">Works for Tape and Piano by BlankFor.ms</a></iframe>
