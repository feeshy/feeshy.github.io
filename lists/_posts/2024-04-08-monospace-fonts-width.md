...
| 文泉驿等宽微米黑 (Wenquanyi Micro Hei Mono)                     | 0.6   | Droid Sans Fallback + Droid Sans Mono<br>远古时期Android默认字体的拼接，无字形区分                                                                                                                                                       |
| Roboto Mono                                             | 0.6   | Android默认等宽字体，[开源](https://github.com/googlefonts/RobotoMono)                                                                                                                                                           |
| Noto Sans Mono                                          | 0.6   | 作为Android fallback字体的等宽字体，[开源](https://github.com/notofonts/noto-fonts)                                                                                                                                                 |
...
| Cascadia Code                                           | ≈0.59 | VS Code默认字体，[开源](https://github.com/microsoft/cascadia-code)，有编程连字。就差那么一丢丢对不齐。有一个正在开发中的衍生字体Cascadia Next是0.5宽度                                                                                                          |
| Consolas                                                | 0.55  | 微软出品，经典编程字体                                                                                                                                                                                                             |
| Intel One Mono                                          | ≈0.62 | [开源字体](https://github.com/intel/intel-one-mono)                                                                                                                                                                         |
| LXGW Bright Code                                        | 0.5   | 霞鹜文楷 + Monaspace Argon 或 Nerd Font，[开源](https://github.com/lxgw/LxgwBright-Code)，有字形区分                                                                                                                                  |
| Maple Mono                                              | 0.6   | 提供多种连字预设的[开源字体](https://github.com/subframe7536/maple-font)。与其他缩窄西文实现中英对齐的字体不同，这款字体采用正常宽度的西文字体，通过**增加中文字间距**实现1:2对齐，更适合西文代码与中文注释混排的编程环境，但也只能使用其内嵌的中文字形。（P.S.中文字形倒是能与任意其他0.6宽度的西文字体组合对齐）                                 |
| 新晰黑 Code                                                | 0.5   | 霞鹜新晰黑 + Migu 1M，[开源](https://github.com/lxgw/NeoXiHei-Code)，有字形区分                                                                                                                                                       |
