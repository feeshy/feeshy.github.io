...
toc: true
image: /assets/img/push_shortcuts.avif
---
...
![screenshot](/assets/img/push_gen_token.webp)
...
- 推荐方式：用这个<img class="sticker" src="/assets/img/pushid.webp">[一次性快捷指令](https://www.icloud.com/shortcuts/c42625de2c494754be617595472afd27)完成这两个过程，用完即删。
...
- 推送接收二合一版
	- <img class="sticker" src="/assets/img/pushup.webp">[推送&接收Shortcut](https://www.icloud.com/shortcuts/0dfcecfcbca046a98980ef826d4825e9)：推送共享表单，或提取收到的内容，**无推送剪贴板功能**
- 独立版
    - <img class="sticker" src="/assets/img/pushup.webp">[推送Shortcut](https://www.icloud.com/shortcuts/a44bcaf20bc74139ade91abde00ebaa9)：推送共享表单或**剪贴板**中的内容
    - <img class="sticker" src="/assets/img/pushdn.webp">[接收Shortcut](https://www.icloud.com/shortcuts/921b57d61ed34955a87c1bb30261fa99)：提取收到的内容
...
![screenshot](/assets/img/push_api_access.avif)
...
![screenshot](/assets/img/push_shortcuts.avif)  
...
![screenshot](/assets/img/push_sms.avif)